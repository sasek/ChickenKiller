...
public class StevecArrayAdapter extends ArrayAdapter<rezultat> { //Step 4.8 POPRAVI Stevec -> Rezultati
	LayoutInflater mInflater;
	public StevecArrayAdapter(Context context, int textViewResourceId, List<rezultat> objects) { //Step 4.8 POPRAVI Stevec ->Rezultati
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.one.setText(""+tmp.getPoints()); //Step 4.8 POPRAVI
