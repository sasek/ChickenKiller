...
import edu.sasq.Chickenkiller.android.DBAdapterStevec;
import edu.sasq.Chickenkiller.android.DatabaseHelper;
...
public class DBAdapterStevec implements BaseColumns {
	...
	//---insert a stevec
	public long insertStevc(rezultat a) 
	{
		ContentValues initialValues = new ContentValues();
		initialValues.put(NAME, a.getIme()); 
		initialValues.put(VALUE, a.getPoints()); 
